...
public class LoginTest extends Base{
	...
	@Test(priority=2,groups= {"regression"}, retryAnalyzer=retry.Retry.class)
	...
	@Test(priority=3,groups= {"regression"}, retryAnalyzer=retry.Retry.class)
...
@Test(priority=4,groups= {"regression"}, retryAnalyzer=retry.Retry.class)
